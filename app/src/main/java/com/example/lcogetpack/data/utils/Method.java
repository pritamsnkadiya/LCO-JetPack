package com.example.lcogetpack.data.utils;
...
public class Method {
    ...
    public static void logInProgressDialogCall(Activity activity) {
    ...
    public static void logProgressDialogCall(Activity activity) {
        hud = KProgressHUD.create(activity)
                .setStyle(KProgressHUD.Style.SPIN_INDETERMINATE)
                .setLabel("Please wait")
                .setDetailsLabel("File uploading....")
                .setDimAmount(0.5f)
                .setCancellable(true);
        hud.show();
    }
