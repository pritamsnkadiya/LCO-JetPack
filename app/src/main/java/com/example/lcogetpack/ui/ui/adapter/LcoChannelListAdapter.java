...
public class LcoChannelListAdapter extends RecyclerView.Adapter<LcoChannelListAdapter.ViewHolder> {

    private static String TAG = LcoChannelListAdapter.class.getName();
    private Context context;
    private Activity activity;
    private List<AllListData> modelArrayList;
    private LayoutInflater layoutInflater;

    public LcoChannelListAdapter(Context context, Activity activity, ArrayList<AllListData> modelArrayList) {
